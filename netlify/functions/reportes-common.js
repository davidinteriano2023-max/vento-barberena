...
const FIREBASE_PROJECT_ID = process.env.FIREBASE_PROJECT_ID || 'ventobarberena-cotizador';
const FIREBASE_API_KEY    = process.env.FIREBASE_API_KEY    || 'AIzaSyD8MUzezXAT9EFy2RMKGyRSCaMfJIBmwIU';
